...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/small-dawn-9b65
```

A live public deployment of this template is available at [https://small-dawn-9b65.templates.workers.dev](https://small-dawn-9b65.templates.workers.dev)
